...
public class ProductApp {
		...
		switch (choice) {
			...
			case 2:
				...
				if(productDAO.isProductExists(productId)) {
					...
					System.out.println("Product with product id : " + productId + " does not exist, hence cannot be deleted.");
				}
				break;
			...
			case 4:
				...
				if (productDAO.isProductExists(productId)) {
					Product temp = productDAO.searchProductId(productId);
			...
			case 5:
				...
				productName = scanner.next();
				products = productDAO.searchProductName(productName);
				if (products.size() == 0) {
			...
			case 6:
				...
				products = productDAO.printAllProducts();
				printProductDetails(products);
			...
			case 7:
				...
				products = productDAO.searchProductPrice(lowerprice, upperprice);
				if (products.size() == 0) {
					System.out.println("No products matching your criteria");
					continue;
				}
	...
	@Override
	public int hashCode() {
		return Objects.hash(choice, product, productDAO, scanner);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProductApp other = (ProductApp) obj;
		return choice == other.choice && Objects.equals(product, other.product)
				&& Objects.equals(productDAO, other.productDAO) && Objects.equals(scanner, other.scanner);
	}
